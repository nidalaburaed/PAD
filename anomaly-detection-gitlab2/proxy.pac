/*
** automatic proxy configuration V2.1 for 10.145.181.251 from 10.158.55.18 (10.158.55.18)
*/
function FindProxyForURL(url, host) {
 ...
 if (host == "alucloud.com") {  return "DIRECT"; }
 ...
 if (host == "https://outlook.office365.com") {  return "DIRECT"; }
 if (host == "eu-p.serviceportal.hp.com") {  return "DIRECT"; }
 if (shExpMatch(host,"*app.nokia.com") ) {  return "DIRECT"; }
 if ( dnsDomainIs(host, ".blob.core.windows.net") ) {  return "PROXY defraprx-fihelprx.glb.nsn-net.net:8080"; }
 if ( dnsDomainIs(host, ".store.core.windows.net") ) {  return "PROXY defraprx-fihelprx.glb.nsn-net.net:8080"; }
 ...
 if ( dnsDomainIs(host, ".nbnco.net.au") ) {  return "PROXY 139.188.28.1:8080"; }
 ...
 if (host == "cartodb-basemaps-c.global.ssl.fastly.net") {  return proxy; }
 ...
 if ( dnsDomainIs(host, ".nokia.net") ) {  return "DIRECT"; }
 if ( dnsDomainIs(host, ".eu-de.containers.appdomain.cloud") ) {  return "PROXY fihelprx-defraprx.glb.nsn-net.net:8080"; }
 ...
 if ( isInNet(resolved_host, "135.109.192.0","255.255.192.0") ) { return "DIRECT"; }
 ...
 if ( isInNet(resolved_host, "185.32.192.0","255.255.255.0") ) { return "PROXY defraprx-fihelprx.glb.nsn-net.net:8080"; }
 ...
 if ( isInNet(resolved_host, "192.11.28.0","255.255.252.0") ) { return proxy; }
 ...
 if ( isInNet(resolved_host, "135.87.4.0","255.252.0.0") ) { return proxy; }
 ...
 if ( isInNet(resolved_host, "100.64.0.0","255.192.0.0") ) { return "DIRECT"; }
}
 return proxy;
}
