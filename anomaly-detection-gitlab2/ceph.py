...
class CephConnect:
    def __init__(self, access_key = None, secret_key = None, object_store = None, object_store_endpoint = None):
      self.boto_settings = {
          'access_key': 'dae2d9136c5e41b79b2ba8017b6ca4db',
          'secret_key': '14f0cd9e32c6488d9f0b5acfc12523ae',
          'object_store': 'phub-1572446946-12',
          'object_store_endpoint': 'http://es-si-s3-z4.eecloud.nsn-net.net:10052/phub-1572446946-12'
      }
